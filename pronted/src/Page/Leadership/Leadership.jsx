...
const Leadership = () => {
  ...
  return (
    <motion.div className="container max-w-7xl mx-auto px-4 py-32" initial="hidden" animate="visible">
      ...
      <motion.div className="flex flex-col md:flex-row gap-12 mb-24 items-center" variants={fadeInVariants}>
