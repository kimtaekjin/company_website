...
const Contact = () => {
  ...
  return (
    <motion.div className="bg-white py-20 lg:py-40" initial="hidden" animate="visible">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <motion.div className="mb-12 max-w-4xl mx-auto" variants={mapVariant} initial="hidden" animate="visible">
        ...
        <motion.div className="mt-12 text-center" variants={buttonVariant} initial="hidden" animate="visible">
          <Link
            to="/contact"
