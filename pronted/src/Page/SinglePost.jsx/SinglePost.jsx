...
import { Container, Paper, Typography, Divider, Box, Chip, Skeleton, IconButton, Snackbar } from "@mui/material";
        ...
        <PostHeader>
          <Box sx={{ flexGrow: 1 }}>
            ...
            <Box sx={{ display: "flex", gap: 2, color: "text.secondary" }}>
              <Typography variant="body2">{format(new Date(post.createdAt), "yyyy-MM-dd HH:mm:ss")}</Typography>
            </Box>
          </Box>
        </PostHeader>
